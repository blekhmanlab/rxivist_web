    ...
    <div class="container" id="main">
      <div class="row">
        <div class="col-lg-9">
          ...
          <h2>Content</h2>
            <p>Rxivist builds profiles of papers and authors using only content pulled directly from <a href="https://biorxiv.org">bioRxiv</a>. If we have erroneously interpreted the data, or have problematically outdated information about a paper or author, please contact Richard Abdill at <strong>rabdill@umn.edu</strong>.
        </div>
