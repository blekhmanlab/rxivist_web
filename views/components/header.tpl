...
<div class="row">
  ...
  % if displaystats:
    <div class="col-md-6">
      <p>Rxivist uses download data on preprints from <a href="https://biorxiv.org" target="_blank">bioRxiv</a> to help you <strong>find the papers being discussed</strong> in your field. Currently indexing <strong>{{ helpers.formatNumber(stats["papers_indexed"]) }} bioRxiv papers</strong> from <strong>{{ helpers.formatNumber(stats["authors_indexed"]) }} authors</strong>.
      <br>
