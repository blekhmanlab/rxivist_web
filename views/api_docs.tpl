    ...
    <div class="container" id="main">
      ...
      <div class="row">
        ...
        <div class="col-sm-10 offset-sm-1">
          ...
          <p>If you are planning to use the Rxivist data within a web application, it would be much appreciated if you <strong>link to Rxivist</strong> on any page that displays a non-trivial amount of data pulled from this API. If you use Rxivist data in your research, please cite our paper, <a href="*tk">"Paper Title *tk."</a> Also, let us know what you're up to! We'd love to find out how this data is being used.

          <p>While we're talking about third-party web applications, we should here that <strong>we can't guarantee this API will be around forever</strong>. We plan to keep it running (and updated!) for the foreseeable future, but if you're going to build something using the Rxivist API that requires a strong uptime commitment or a concrete promise of long-term functionality, consider deploying your own version of <a href="https://github.com/rabdill/rxivist">the software</a>. We'll provide as much guidance as we can.
          ...
          <h3>Etiquette</h3>
            ...
            <ul>
              ...
              <li>Report problems and/or ask questions on <a href="https://github.com/rabdill/rxivist/issues">our issue tracker</a>.
            </ul>
