    ...
    <div class="container" id="main">
      ...
      <div class="row">
        ...
        <div class="col-sm-10 offset-sm-1">
          <p>The Rxivist API offers free, programmatic access to all of our bioRxiv metadata in a JSON interface. It's open to all&mdash;no keys or authentication here, at least for now. We only ask that you go easy on the requests, as this is a small project with limited funding for server infrastructure.
          ...
          <p>If you are planning to use the Rxivist data within a web application, please <strong>cite and link to Rxivist</strong> on any page that displays a non-trivial amount of data pulled from this API. Also, let us know what you're up to! We'd love to find out how this data is being used.
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
